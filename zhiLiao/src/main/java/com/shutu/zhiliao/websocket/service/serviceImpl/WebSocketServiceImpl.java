package com.shutu.zhiliao.websocket.service.serviceImpl;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.shutu.zhiliao.common.event.GroupMessageEvent;
import com.shutu.zhiliao.common.event.PrivateMessageEvent;
import com.shutu.zhiliao.config.ThreadPoolConfig;
import com.shutu.zhiliao.model.dto.GroupMessageDTO;
import com.shutu.zhiliao.model.dto.PrivateMessageDTO;
import com.shutu.zhiliao.model.entity.UserRoomRelate;
...
import com.shutu.zhiliao.model.vo.ws.response.ChatMessageResp;
import com.shutu.zhiliao.model.vo.ws.response.WSBaseResp;
import com.shutu.zhiliao.service.UserRoomRelateService;
import com.shutu.zhiliao.websocket.adapter.WSAdapter;
...
public class WebSocketServiceImpl implements WebSocketService {
     ...
     */
    @Override
    public void sendMessage(Channel channel, WSBaseRequest req) {
    ...
    @Override
    public void sendMessage(String token, WSBaseRequest req) {
